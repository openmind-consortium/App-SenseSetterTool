...
namespace UCSF_StarrLab_SenseSetter.Services
{
    ...
    class CalculatePowerBins
    {
        ...
        public List<double> CalculateFFTBins(int fftSize, int timeRate)
        {
            ...
            switch (fftSize)
            {
                ...
                case 1024:
                    ...
                    break;
                default:
                    MessageBox.Show("Could not convert FFT Size for FFT bins", "Error", MessageBoxButton.OK, MessageBoxImage.Hand);
                    break;
            }
            int rate = 0;
            switch (timeRate)
            {
                ...
                case 1000:
                    ...
                    break;
                default:
                    MessageBox.Show("Could not convert TDSampleRate for FFT bins", "Error", MessageBoxButton.OK, MessageBoxImage.Hand);
                    break;
            }
